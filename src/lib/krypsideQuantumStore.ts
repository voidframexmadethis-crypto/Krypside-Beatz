// ==========================================
// KRYPSIDE QUANTUM CORE: STANDALONE ZERO-KEY ENGINE
// ==========================================
...
export class KrypsideQuantumStore {
    storageKey: string;

    constructor() {
        this.storageKey = "krypside_standalone_vault_v1";
            ...
            if (!localStorage.getItem(this.storageKey)) {
                const initialData: QuantumStoreState = {
                    ...
                    tracks: [
                        ...
                        {
                            id: "track_2",
                            title: "Sub-Zero | Future x Metro Boomin Type Beat",
                            producer: "KRYPSIDE",
                            bpm: 144,
                            key: "C# Minor",
                            genre: "Dark Trap",
                        ...
                        {
                            id: "track_3",
                            title: "Hellcat | Ken Carson x Opium Trap",
                            producer: "KRYPSIDE",
                            bpm: 152,
                            key: "E Minor",
                            genre: "Rage & Opium Beats",
                            price: 14.99,
    ...
    getState(): QuantumStoreState {
        try {
            ...
            return {
                config: { storeName: "KRYPSIDE", tagline: "Dark Trap & Southside Beats", currency: "USD" },
                tracks: [],
                cart: []
            };
        }
...
export function handleCheckout(trackId: string) {
    try {
        ...
        // Check KrypsideLightVault first, then krypside_standalone_vault_v1
        const rawLight = localStorage.getItem("KrypsideLightVault");
        if (rawLight) {
        ...
        if (!targetTrack) {
            const state = krypsideEngine.getState();
...
export const krypsideEngine = new KrypsideQuantumStore();
